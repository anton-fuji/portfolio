            ...
            <section>
                ...
                <div className="container mx-auto px-8">
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-8 justify-center-safe'>
                        {zenn.map((plat) => (
                            <Card key={plat.url} className='flex justify-evenly p-6 pl-6 rounded-xl bg-[#0a0a0a]/90 background-blur-sm border-white/20 hover:shadow-lg hover:-trancelate-y-1 '>
